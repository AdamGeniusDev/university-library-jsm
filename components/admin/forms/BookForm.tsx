        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      ...
                      <FormControl>
                        ...
                        className="book-form_input" {...field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-1">
                    ...
                    <FormControl>
                      <Input required placeholder="Book Author"  
                      className="book-form_input" {...field}/>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
               ...
               <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      ...
                      <FormControl>
                        <Input required placeholder="Book Genre"  
                        className="book-form_input" {...field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      ...
                      <FormControl>
                        <Input required type="number" min={1} max={5} placeholder="Book rating"  
                        className="book-form_input"  {...field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      ...
                      <FormControl>
                        <Input required type="number" min={1} max={10000} placeholder="Total Copies"  
                        className="book-form_input"  {...field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1">
                      ...
                      <FileUpload type="video" accept="video/*" placeholder="Upload a book trailer"
                        folder="books/video" variant="light"
                         onFileChange={field.onChange} value={field.value} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
